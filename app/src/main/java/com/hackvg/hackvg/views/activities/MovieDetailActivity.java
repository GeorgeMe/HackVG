package com.hackvg.hackvg.views.activities;
...
import com.hackvg.hackvg.R;
import com.hackvg.hackvg.di.components.DaggerMovieUsecasesComponent;
import com.hackvg.hackvg.di.modules.MovieUsecasesModule;
import com.hackvg.hackvg.mvp.presenters.MovieDetailPresenter;
import com.hackvg.hackvg.mvp.views.DetailView;
import com.hackvg.hackvg.utils.GUIUtils;
import com.hackvg.hackvg.utils.TransitionUtils;
import com.hackvg.hackvg.views.custom_listeners.AnimatorAdapter;
import com.hackvg.hackvg.views.custom_listeners.TransitionAdapter;
import com.hackvg.hackvg.views.custom_views.ObservableScrollView;
import com.hackvg.hackvg.views.custom_views.ScrollViewListener;
...
public class MovieDetailActivity extends Activity implements DetailView,
    ...
    public void showMovieImage(String url) {
        Log.e(MovieDetailActivity.class.getSimpleName(),url);
...
//
    ...
    private void setVibrantElements(Swatch vibrantSwatch) {
        if(vibrantSwatch!=null){
            ...
            mFabButton.getBackground().setColorFilter(getResources().getColor(R.color.movie_detail_fabbutton),PorterDuff.Mode.MULTIPLY);
        }
